...
namespace Wk1Ex2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string firstName = Console.ReadLine(); //recieves input and assigns it as firstName
            Console.WriteLine("What is your last name?"); //prints question
            string lastName = Console.ReadLine(); //recieves input and assigns it as lastName

            Console.WriteLine("What is your age?"); //prints question
            int age = Convert.ToInt16(Console.ReadLine()); //recieves input, assigns it as age, and converts input to an int type
            Console.WriteLine("What is your favorite color?"); //prints question
            string color = Console.ReadLine(); //recieves input and assigns it as color
